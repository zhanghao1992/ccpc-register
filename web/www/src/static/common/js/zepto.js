...
!function (t, e) {
    ...
    var e = function () {
        ...
        return N.matches = function (t, e) {
            ...
            wrap: function (t) {
                var e = F(t);
                if (this[0] && !e) {
                    var n = r(t).get(0), i = n.parentNode || this.length > 1;
                }
    ...
    return t.Zepto = e, void 0 === t.$ && (t.$ = e), function (e) {
        ...
        u.click = u.mousedown = u.mouseup = u.mousemove = "MouseEvents", e.event = {
            ...
            if (s(n)) {
                return r ? (r.unshift(t[n], t), e.proxy.apply(null, r)) : e.proxy(t[n], t);
            }
            ...
            if (N.setRequestHeader = b, N.onreadystatechange = function () {
                    if (4 == N.readyState) {
                        ...
                        if (N.status >= 200 && N.status < 300 || 304 == N.status || 0 == N.status && "file:" == C) {
                            if (c = c || w(s.mimeType || N.getResponseHeader("content-type")), "arraybuffer" == N.responseType || "blob" == N.responseType) {
                                t = N.response;
                            } else {
                                t = N.responseText;
                                try {
