...
//					'<td class="plupload_cell plupload_file_size">' + _('Size') + '</td>' +//文件大小不准确，暂时隐藏
					'<td class="plupload_cell plupload_file_size">&nbsp;</td>' +
...
//					'<td class="plupload_file_size"><span class="plupload_total_file_size">0 kb</span></td>' +//文件大小不准确，暂时隐藏
...
//						.html(plupload.formatSize(file.size));			//文件大小不准确，暂时隐藏
						.html('&nbsp;');
				break;
		}
...
//				.html(plupload.formatSize(up.total.size))//文件大小不准确，暂时隐藏
				.html('&nbsp;')
				.end()
	...
	_addFiles: function(files) {
		...
		file_html = '<li class="plupload_file ui-state-default plupload_delete" id="{id}" style="width:{thumb_width}px;">' +
			...
			'</div>' +
//			'<div class="plupload_file_size">{size} </div>' +//文件大小不准确，暂时隐藏
